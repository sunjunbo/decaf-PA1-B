...
abstract class AbstractParser {
    ...
    protected SemValue svTypes(Tree.TypeLit... vars) {
        var v = new SemValue(SemValue.Kind.TYPE_LIST, vars.length == 0 ? Pos.NoPos : vars[0].pos);
        v.typeList = new ArrayList<>();
        v.typeList.addAll(Arrays.asList(vars));
        return v;
    }
